...
### implement meta training on these new datasets
### to get data:
catsDf = pd.read_csv('/home/miles/final/cats/data/cats.csv',sep=',',engine='python')
birdsDf = pd.read_csv('/home/miles/final/birds/birds.csv')
